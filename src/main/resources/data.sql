insert into db.clinic (id, address, city, clinic_average_rating, description, name, times_rated) values ('1', 'Sime Milosevica', 'Novi Sad', '9', 'Ludara', 'Dom Bajic', '2');
...
insert into db.users (type, id, address, city, country, email, enabled, first_name, last_name, last_password_reset_date, password, phone, ssn, average_rating, times_rated, clinic_id) values ('CA', '5', 'Pejicevi Salasi', 'Novi Sad', 'Srbija', 'ca@gmail.com', b'1', 'Djordje', 'Cvarkov', '2019-12-03 19:00:00.000000', '$2a$10$DPpa3Slt3jcwkynr.9WSaO70xTGYYK8iDlX5H89fry1vHxlLUPE0C', '444444444', '4444444444444', null, null, '2');
insert into db.users (type, id, address, city, country, email, enabled, first_name, last_name, last_password_reset_date, password, phone, ssn, average_rating, times_rated, clinic_id) values ('DO', '6', 'Streetic', 'Cityic', 'Serbia', 'doctor@gmail.com', b'1', 'Lekar', 'Lekaric', '2019-12-03 19:00:00.000000', '$2a$10$DPpa3Slt3jcwkynr.9WSaO70xTGYYK8iDlX5H89fry1vHxlLUPE0C', '222222222', '2222222222222', '9', '1', '2');
insert into db.users (type, id, address, city, country, email, enabled, first_name, last_name, last_password_reset_date, password, phone, ssn, average_rating, times_rated, clinic_id) values ('DO', '7', 'Zdrid', 'Zidi', 'Zrbija', 'doc@yahoo.com', b'1', 'Zdravko', 'Herbiko', '2019-12-03 19:00:00.000000', '$2a$10$DPpa3Slt3jcwkynr.9WSaO70xTGYYK8iDlX5H89fry1vHxlLUPE0C', '222222222', '2222222222222', '9', '1', '3');
insert into db.users (type, id, address, city, country, email, enabled, first_name, last_name, last_password_reset_date, password, phone, ssn, average_rating, times_rated, clinic_id) values ('NU', '8', 'Danila Kisa', 'Novi Sad', 'Zrbija', 'jekibp@gmail.com', b'1', 'Mika', 'Mikic', '2019-12-03 19:00:00.000000', '$2a$10$DPpa3Slt3jcwkynr.9WSaO70xTGYYK8iDlX5H89fry1vHxlLUPE0C', '222222222', '2222222222222', '9', '1', '1');
...
insert into db.user_authority (user_id, authority_id) values ('6', '2');
insert into db.user_authority (user_id, authority_id) values ('7', '2');
insert into db.user_authority (user_id, authority_id) values ('8', '3');
